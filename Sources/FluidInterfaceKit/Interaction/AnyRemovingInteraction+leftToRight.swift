...
extension AnyRemovingInteraction {
        ...
        .gestureOnLeftEdge(
          ...
          handler: { gesture, context in
            ...
            let backViewController: UIViewController? = {
              guard
                let controllers = context.viewController.fluidStackContext?.fluidStackController?
            ...
            case .began, .changed:
              ...
              if trackingContext == nil {
                ...
                backViewController?.view.transform = currentTransform.translatedBy(
                  x: -view.bounds.width,
                  y: 0
                )
            ...
            case .ended:
              ...
              if progress > 0.5 || velocity.x > 300 {
                ...
                let animator = UIViewPropertyAnimator(duration: 0.62, dampingRatio: 1) {
                  ...
                  backViewController?.view.transform = view.transform.translatedBy(
                    x: -view.bounds.width,
                    y: 0
                  )
                }
  ...
  // FIXME: not completed
  public static var leftToRightOnScreen: Self {
